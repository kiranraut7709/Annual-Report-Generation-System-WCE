...
urlpatterns = [
    path('/', include([
        ...
        path('showAllPhdData', views.showAllPhdData, name="showAllPhdData"),
        path('addPHD', views.addPHD, name="addPHD"),
        path('updatePhdData/<str:phd_id>', views.updatePhdData, name="updatePhdData"),
        path('phdDetailsDelete/<str:phd_id>', views.phdDetailsDelete, name="phdDetailsDelete"),
        ...
        path('showAllGuidePhdData', views.showAllGuidePhdData, name="showAllGuidePhdData"),
        path('addGuidePHD', views.guideAddPHD, name="addGuidePHD"),
        path('updateGuidePhdData/<str:phd_id>', views.updateGuidePhdData, name="updateGuidePhdData"),
