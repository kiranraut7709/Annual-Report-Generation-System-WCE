...
def generateReportResult(request, fromYear, toYear):
    ...
    allCompletedPHDCSE = PhdCSE.objects.filter(academic_year__lte=toYear).filter(status=True)
    allCompletedPHDIT = PhdIT.objects.filter(academic_year__lte=toYear).filter(status=True)
    allCompletedPHDCV = PhdCV.objects.filter(academic_year__lte=toYear).filter(status=True)
    allCompletedPHDME = PhdME.objects.filter(academic_year__lte=toYear).filter(status=True)
    allCompletedPHDEL = PhdEL.objects.filter(academic_year__lte=toYear).filter(status=True)
    allCompletedPHDETN = PhdETN.objects.filter(academic_year__lte=toYear).filter(status=True)

    # PHD Details - Ongoing
    allOngoingPHDCSE = PhdCSE.objects.filter(academic_year__gte=fromYear, academic_year__lte=toYear).filter(status=False).values('title', 'faculty_name', 'department', 'guide_name', 'registration_date', 'completion_date', 'status').annotate(dCount=Count('phd_id'))
    allOngoingPHDME = PhdME.objects.filter(academic_year__gte=fromYear, academic_year__lte=toYear).filter(status=False).values('title', 'faculty_name', 'department', 'guide_name', 'registration_date', 'completion_date', 'status').annotate(dCount=Count('phd_id'))
    allOngoingPHDCV = PhdCV.objects.filter(academic_year__gte=fromYear, academic_year__lte=toYear).filter(status=False).values('title', 'faculty_name', 'department', 'guide_name', 'registration_date', 'completion_date', 'status').annotate(dCount=Count('phd_id'))
    allOngoingPHDIT = PhdIT.objects.filter(academic_year__gte=fromYear, academic_year__lte=toYear).filter(status=False).values('title', 'faculty_name', 'department', 'guide_name', 'registration_date', 'completion_date', 'status').annotate(dCount=Count('phd_id'))
    allOngoingPHDEL = PhdEL.objects.filter(academic_year__gte=fromYear, academic_year__lte=toYear).filter(status=False).values('title', 'faculty_name', 'department', 'guide_name', 'registration_date', 'completion_date', 'status').annotate(dCount=Count('phd_id'))
    allOngoingPHDETN = PhdETN.objects.filter(academic_year__gte=fromYear, academic_year__lte=toYear).filter(status=False).values('title', 'faculty_name', 'department', 'guide_name', 'registration_date', 'completion_date', 'status').annotate(dCount=Count('phd_id'))
    ...
    allPhdStudentOtherCSE = GuideforPHDCSE.objects.filter(academic_year__lte=toYear).filter(type_of_phd="Other").filter(status=True).order_by("guide_name")
    allPhdStudentOtherME = GuideforPHDME.objects.filter(academic_year__lte=toYear).filter(type_of_phd="Other").filter(status=True).order_by("guide_name")
    allPhdStudentOtherIT = GuideforPHDIT.objects.filter(academic_year__lte=toYear).filter(type_of_phd="Other").filter(status=True).order_by("guide_name")
    allPhdStudentOtherCV = GuideforPHDCV.objects.filter(academic_year__lte=toYear).filter(type_of_phd="Other").filter(status=True).order_by("guide_name")
    allPhdStudentOtherEL = GuideforPHDEL.objects.filter(academic_year__lte=toYear).filter(type_of_phd="Other").filter(status=True).order_by("guide_name")
    allPhdStudentOtherETN = GuideforPHDETN.objects.filter(academic_year__lte=toYear).filter(type_of_phd="Other").filter(status=True).order_by("guide_name")

    # Ph.D.Student Details registered under WCE faculty(QIP - Ph.D. students)
    allPhdStudentQIPCSE = GuideforPHDCSE.objects.filter(academic_year__lte=toYear).filter(type_of_phd="QIP").filter(status=True).order_by("guide_name")
    allPhdStudentQIPME = GuideforPHDME.objects.filter(academic_year__lte=toYear).filter(type_of_phd="QIP").filter(status=True).order_by("guide_name")
    allPhdStudentQIPIT = GuideforPHDIT.objects.filter(academic_year__lte=toYear).filter(type_of_phd="QIP").filter(status=True).order_by("guide_name")
    allPhdStudentQIPCV = GuideforPHDCV.objects.filter(academic_year__lte=toYear).filter(type_of_phd="QIP").filter(status=True).order_by("guide_name")
    allPhdStudentQIPEL = GuideforPHDEL.objects.filter(academic_year__lte=toYear).filter(type_of_phd="QIP").filter(status=True).order_by("guide_name")
    allPhdStudentQIPETN = GuideforPHDETN.objects.filter(academic_year__lte=toYear).filter(type_of_phd="QIP").filter(status=True).order_by("guide_name")

    # Ph.D.Student Details registered under WCE faculty(NDF Ph.D. students)
    allPhdStudentNDFCSE = GuideforPHDCSE.objects.filter(academic_year__lte=toYear).filter(type_of_phd="NDF").filter(status=True).order_by("guide_name")
    allPhdStudentNDFME = GuideforPHDME.objects.filter(academic_year__lte=toYear).filter(type_of_phd="NDF").filter(status=True).order_by("guide_name")
    allPhdStudentNDFIT = GuideforPHDIT.objects.filter(academic_year__lte=toYear).filter(type_of_phd="NDF").filter(status=True).order_by("guide_name")
    allPhdStudentNDFCV = GuideforPHDCV.objects.filter(academic_year__lte=toYear).filter(type_of_phd="NDF").filter(status=True).order_by("guide_name")
    allPhdStudentNDFEL = GuideforPHDEL.objects.filter(academic_year__lte=toYear).filter(type_of_phd="NDF").filter(status=True).order_by("guide_name")
    allPhdStudentNDFETN = GuideforPHDETN.objects.filter(academic_year__lte=toYear).filter(type_of_phd="NDF").filter(status=True).order_by("guide_name")

    # Ph.D.Student Details registered under WCE faculty(other than QIP - Ph.D. and NDF students) Ongoing
    allPhdStudentOngoingOtherCSE = GuideforPHDCSE.objects.filter(academic_year__gte=fromYear, academic_year__lte=toYear).filter(type_of_phd="Other").filter(status=False).order_by("guide_name").values('student_name', 'title_thesis', 'guide_name', 'comment_on_thesis', 'registration_date', 'completion_date', 'status').annotate(dCount=Count('phd_id'))
    allPhdStudentOngoingOtherME = GuideforPHDME.objects.filter(academic_year__gte=fromYear, academic_year__lte=toYear).filter(type_of_phd="Other").filter(status=False).order_by("guide_name").values('student_name', 'title_thesis', 'guide_name', 'comment_on_thesis', 'registration_date', 'completion_date', 'status').annotate(dCount=Count('phd_id'))
    allPhdStudentOngoingOtherIT = GuideforPHDIT.objects.filter(academic_year__gte=fromYear, academic_year__lte=toYear).filter(type_of_phd="Other").filter(status=False).order_by("guide_name").values('student_name', 'title_thesis', 'guide_name', 'comment_on_thesis', 'registration_date', 'completion_date', 'status').annotate(dCount=Count('phd_id'))
    allPhdStudentOngoingOtherCV = GuideforPHDCV.objects.filter(academic_year__gte=fromYear, academic_year__lte=toYear).filter(type_of_phd="Other").filter(status=False).order_by("guide_name").values('student_name', 'title_thesis', 'guide_name', 'comment_on_thesis', 'registration_date', 'completion_date', 'status').annotate(dCount=Count('phd_id'))
    allPhdStudentOngoingOtherEL = GuideforPHDEL.objects.filter(academic_year__gte=fromYear, academic_year__lte=toYear).filter(type_of_phd="Other").filter(status=False).order_by("guide_name").values('student_name', 'title_thesis', 'guide_name', 'comment_on_thesis', 'registration_date', 'completion_date', 'status').annotate(dCount=Count('phd_id'))
    allPhdStudentOngoingOtherETN = GuideforPHDETN.objects.filter(academic_year__gte=fromYear, academic_year__lte=toYear).filter(type_of_phd="Other").filter(status=False).order_by("guide_name").values('student_name', 'title_thesis', 'guide_name', 'comment_on_thesis', 'registration_date', 'completion_date', 'status').annotate(dCount=Count('phd_id'))

    # Ph.D.Student Details registered under WCE faculty(QIP - Ph.D. students) Ongoing
    allPhdStudentOngoingQIPCSE = GuideforPHDCSE.objects.filter(academic_year__gte=fromYear, academic_year__lte=toYear).filter(type_of_phd="QIP").filter(status=False).order_by("guide_name").values('student_name', 'title_thesis', 'guide_name', 'comment_on_thesis', 'registration_date', 'completion_date', 'status').annotate(dCount=Count('phd_id'))
    allPhdStudentOngoingQIPME = GuideforPHDME.objects.filter(academic_year__gte=fromYear, academic_year__lte=toYear).filter(type_of_phd="QIP").filter(status=False).order_by("guide_name").values('student_name', 'title_thesis', 'guide_name', 'comment_on_thesis', 'registration_date', 'completion_date', 'status').annotate(dCount=Count('phd_id'))
    allPhdStudentOngoingQIPIT = GuideforPHDIT.objects.filter(academic_year__gte=fromYear, academic_year__lte=toYear).filter(type_of_phd="QIP").filter(status=False).order_by("guide_name").values('student_name', 'title_thesis', 'guide_name', 'comment_on_thesis', 'registration_date', 'completion_date', 'status').annotate(dCount=Count('phd_id'))
    allPhdStudentOngoingQIPCV = GuideforPHDCV.objects.filter(academic_year__gte=fromYear, academic_year__lte=toYear).filter(type_of_phd="QIP").filter(status=False).order_by("guide_name").values('student_name', 'title_thesis', 'guide_name', 'comment_on_thesis', 'registration_date', 'completion_date', 'status').annotate(dCount=Count('phd_id'))
    allPhdStudentOngoingQIPEL = GuideforPHDEL.objects.filter(academic_year__gte=fromYear, academic_year__lte=toYear).filter(type_of_phd="QIP").filter(status=False).order_by("guide_name").values('student_name', 'title_thesis', 'guide_name', 'comment_on_thesis', 'registration_date', 'completion_date', 'status').annotate(dCount=Count('phd_id'))
    allPhdStudentOngoingQIPETN = GuideforPHDETN.objects.filter(academic_year__gte=fromYear, academic_year__lte=toYear).filter(type_of_phd="QIP").filter(status=False).order_by("guide_name").values('student_name', 'title_thesis', 'guide_name', 'comment_on_thesis', 'registration_date', 'completion_date', 'status').annotate(dCount=Count('phd_id'))

    # Ph.D.Student Details registered under WCE faculty(NDF Ph.D. students) Ongoing
    allPhdStudentOngoingNDFCSE = GuideforPHDCSE.objects.filter(academic_year__gte=fromYear, academic_year__lte=toYear).filter(type_of_phd="NDF").filter(status=False).order_by("guide_name").values('student_name', 'title_thesis', 'guide_name', 'comment_on_thesis', 'registration_date', 'completion_date', 'status').annotate(dCount=Count('phd_id'))
    allPhdStudentOngoingNDFME = GuideforPHDME.objects.filter(academic_year__gte=fromYear, academic_year__lte=toYear).filter(type_of_phd="NDF").filter(status=False).order_by("guide_name").values('student_name', 'title_thesis', 'guide_name', 'comment_on_thesis', 'registration_date', 'completion_date', 'status').annotate(dCount=Count('phd_id'))
    allPhdStudentOngoingNDFIT = GuideforPHDIT.objects.filter(academic_year__gte=fromYear, academic_year__lte=toYear).filter(type_of_phd="NDF").filter(status=False).order_by("guide_name").values('student_name', 'title_thesis', 'guide_name', 'comment_on_thesis', 'registration_date', 'completion_date', 'status').annotate(dCount=Count('phd_id'))
    allPhdStudentOngoingNDFCV = GuideforPHDCV.objects.filter(academic_year__gte=fromYear, academic_year__lte=toYear).filter(type_of_phd="NDF").filter(status=False).order_by("guide_name").values('student_name', 'title_thesis', 'guide_name', 'comment_on_thesis', 'registration_date', 'completion_date', 'status').annotate(dCount=Count('phd_id'))
    allPhdStudentOngoingNDFEL = GuideforPHDEL.objects.filter(academic_year__gte=fromYear, academic_year__lte=toYear).filter(type_of_phd="NDF").filter(status=False).order_by("guide_name").values('student_name', 'title_thesis', 'guide_name', 'comment_on_thesis', 'registration_date', 'completion_date', 'status').annotate(dCount=Count('phd_id'))
    allPhdStudentOngoingNDFETN = GuideforPHDETN.objects.filter(academic_year__gte=fromYear, academic_year__lte=toYear).filter(type_of_phd="NDF").filter(status=False).order_by("guide_name").values('student_name', 'title_thesis', 'guide_name', 'comment_on_thesis', 'registration_date', 'completion_date', 'status').annotate(dCount=Count('phd_id'))
    ...
    # For Displaying Serial No Ph.D.Student Details registered under WCE faculty(other than QIP - Ph.D. and NDF students) Ongoing
    SerialNoPhdStudentOngoingOtherETN = []
    for i in range(n):
        SerialNoPhdStudentOngoingOtherETN.insert(i, i + 1)
    c = n + len(allPhdStudentOngoingOtherCV)
    SerialNoPhdStudentOngoingOtherCV = []
    for i in range(len(allPhdStudentOngoingOtherETN), c):
        SerialNoPhdStudentOngoingOtherCV.insert(i, i + 1)
    SerialNoPhdStudentOngoingOtherME = []
    for i in range(c, len(allPhdStudentOngoingOtherME) + c):
        SerialNoPhdStudentOngoingOtherME.insert(i, i + 1)
    c += len(allPhdStudentOngoingOtherME)
    SerialNoPhdStudentOngoingOtherEL = []
    for i in range(c, len(allPhdStudentOngoingOtherEL) + c):
        SerialNoPhdStudentOngoingOtherEL.insert(i, i + 1)
    c += len(allPhdStudentOngoingOtherEL)
    SerialNoPhdStudentOngoingOtherIT = []
    for i in range(c, len(allPhdStudentOngoingOtherIT) + c):
        SerialNoPhdStudentOngoingOtherIT.insert(i, i + 1)
    c += len(allPhdStudentOngoingOtherIT)
    SerialNoPhdStudentOngoingOtherCSE = []
    for i in range(c, len(allPhdStudentOngoingOtherCSE) + c):
        SerialNoPhdStudentOngoingOtherCSE.insert(i, i + 1)
    ...
    # For Displaying Serial No Ph.D.Student Details registered under WCE faculty(QIP - Ph.D. students) Ongoing
    SerialNoPhdStudentOngoingQIPETN = []
    for i in range(n):
        SerialNoPhdStudentOngoingQIPETN.insert(i, i + 1)
    c = n + len(allPhdStudentOngoingQIPCV)
    SerialNoPhdStudentOngoingQIPCV = []
    for i in range(len(allPhdStudentOngoingQIPETN), c):
        SerialNoPhdStudentOngoingQIPCV.insert(i, i + 1)
    SerialNoPhdStudentOngoingQIPME = []
    for i in range(c, len(allPhdStudentOngoingQIPME) + c):
        SerialNoPhdStudentOngoingQIPME.insert(i, i + 1)
    c += len(allPhdStudentOngoingQIPME)
    SerialNoPhdStudentOngoingQIPEL = []
    for i in range(c, len(allPhdStudentOngoingQIPEL) + c):
        SerialNoPhdStudentOngoingQIPEL.insert(i, i + 1)
    c += len(allPhdStudentOngoingQIPEL)
    SerialNoPhdStudentOngoingQIPIT = []
    for i in range(c, len(allPhdStudentOngoingQIPIT) + c):
        SerialNoPhdStudentOngoingQIPIT.insert(i, i + 1)
    c += len(allPhdStudentOngoingQIPIT)
    SerialNoPhdStudentOngoingQIPCSE = []
    for i in range(c, len(allPhdStudentOngoingQIPCSE) + c):
        SerialNoPhdStudentOngoingQIPCSE.insert(i, i + 1)
    ...
    # For Displaying Serial No Ph.D.Student Details registered under WCE faculty(NDF Ph.D. students) Ongoing
    SerialNoPhdStudentOngoingNDFETN = []
    for i in range(n):
        SerialNoPhdStudentOngoingNDFETN.insert(i, i + 1)
    c = n + len(allPhdStudentOngoingNDFCV)
    SerialNoPhdStudentOngoingNDFCV = []
    for i in range(len(allPhdStudentOngoingNDFETN), c):
        SerialNoPhdStudentOngoingNDFCV.insert(i, i + 1)
    SerialNoPhdStudentOngoingNDFME = []
    for i in range(c, len(allPhdStudentOngoingNDFME) + c):
        SerialNoPhdStudentOngoingNDFME.insert(i, i + 1)
    c += len(allPhdStudentOngoingNDFME)
    SerialNoPhdStudentOngoingNDFEL = []
    for i in range(c, len(allPhdStudentOngoingNDFEL) + c):
        SerialNoPhdStudentOngoingNDFEL.insert(i, i + 1)
    c += len(allPhdStudentOngoingNDFEL)
    SerialNoPhdStudentOngoingNDFIT = []
    for i in range(c, len(allPhdStudentOngoingNDFIT) + c):
        SerialNoPhdStudentOngoingNDFIT.insert(i, i + 1)
    c += len(allPhdStudentOngoingNDFIT)
    SerialNoPhdStudentOngoingNDFCSE = []
    for i in range(c, len(allPhdStudentOngoingNDFCSE) + c):
        SerialNoPhdStudentOngoingNDFCSE.insert(i, i + 1)
    ...
    args = {
        ...
        "allPhdStudentOngoingOtherCV": allPhdStudentOngoingOtherCV,
        "allPhdStudentOngoingOtherIT": allPhdStudentOngoingOtherIT,
        "allPhdStudentOngoingOtherCSE": allPhdStudentOngoingOtherCSE,
        "allPhdStudentOngoingOtherME": allPhdStudentOngoingOtherME,
        "allPhdStudentOngoingOtherEL": allPhdStudentOngoingOtherEL,
        "allPhdStudentOngoingOtherETN": allPhdStudentOngoingOtherETN,

        "allPhdStudentOngoingQIPCV": allPhdStudentOngoingQIPCV,
        "allPhdStudentOngoingQIPIT": allPhdStudentOngoingQIPIT,
        "allPhdStudentOngoingQIPCSE": allPhdStudentOngoingQIPCSE,
        "allPhdStudentOngoingQIPME": allPhdStudentOngoingQIPME,
        "allPhdStudentOngoingQIPEL": allPhdStudentOngoingQIPEL,
        "allPhdStudentOngoingQIPETN": allPhdStudentOngoingQIPETN,

        "allPhdStudentOngoingNDFCV": allPhdStudentOngoingNDFCV,
        "allPhdStudentOngoingNDFIT": allPhdStudentOngoingNDFIT,
        "allPhdStudentOngoingNDFCSE": allPhdStudentOngoingNDFCSE,
        "allPhdStudentOngoingNDFME": allPhdStudentOngoingNDFME,
        "allPhdStudentOngoingNDFEL": allPhdStudentOngoingNDFEL,
        "allPhdStudentOngoingNDFETN": allPhdStudentOngoingNDFETN,
        ...
        "SerialNoPhdStudentOngoingOtherCSE": SerialNoPhdStudentOngoingOtherCSE,
        "SerialNoPhdStudentOngoingOtherCV": SerialNoPhdStudentOngoingOtherCV,
        "SerialNoPhdStudentOngoingOtherIT": SerialNoPhdStudentOngoingOtherIT,
        "SerialNoPhdStudentOngoingOtherME": SerialNoPhdStudentOngoingOtherME,
        "SerialNoPhdStudentOngoingOtherEL": SerialNoPhdStudentOngoingOtherEL,
        "SerialNoPhdStudentOngoingOtherETN": SerialNoPhdStudentOngoingOtherETN,

        "SerialNoPhdStudentOngoingQIPCSE": SerialNoPhdStudentOngoingQIPCSE,
        "SerialNoPhdStudentOngoingQIPCV": SerialNoPhdStudentOngoingQIPCV,
        "SerialNoPhdStudentOngoingQIPIT": SerialNoPhdStudentOngoingQIPIT,
        "SerialNoPhdStudentOngoingQIPME": SerialNoPhdStudentOngoingQIPME,
        "SerialNoPhdStudentOngoingQIPEL": SerialNoPhdStudentOngoingQIPEL,
        "SerialNoPhdStudentOngoingQIPETN": SerialNoPhdStudentOngoingQIPETN,

        "SerialNoPhdStudentOngoingNDFCSE": SerialNoPhdStudentOngoingNDFCSE,
        "SerialNoPhdStudentOngoingNDFCV": SerialNoPhdStudentOngoingNDFCV,
        "SerialNoPhdStudentOngoingNDFIT": SerialNoPhdStudentOngoingNDFIT,
        "SerialNoPhdStudentOngoingNDFME": SerialNoPhdStudentOngoingNDFME,
        "SerialNoPhdStudentOngoingNDFEL": SerialNoPhdStudentOngoingNDFEL,
        "SerialNoPhdStudentOngoingNDFETN": SerialNoPhdStudentOngoingNDFETN,
